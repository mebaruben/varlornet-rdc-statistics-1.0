...
const load = () => {
    ...
    dashboardRtncService.getStatNotesPayeesPeriodiqueParSite(selectedSite.value.id, dashboardService.getDateFormat(dateDebut.value), dashboardService.getDateFormat(dateFin.value)).then((response) => {
        loading.value = false;
        ...
        <div class="col-12">
            <div class="card">
                <DataTable :value="noteList" paginator :rows="5" :rowsPerPageOptions="[5, 10, 20, 50]"
                    ...
                    <Column field="datePaiment" header="DATE DE PAIEMENT" style="width: auto"></Column>
