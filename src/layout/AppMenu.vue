            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        label: 'Flotte',
                        icon: 'pi pi-fw pi-bookmark',
                        items: [{ label: 'Nouvelle Affaires', icon: 'pi pi-fw pi-bookmark' }]
                    }
                ]
            },
            {
...
const list = (userConnected.data.module == '3') ? model_sonas :
    (userConnected.data.module == '2') ? model_dgi : model_admin;
